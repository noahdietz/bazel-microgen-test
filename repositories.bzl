...
def com_googleapis_bazel_microgen_test_repositories():
    _maybe(
        http_archive,
    ...
    # TODO: change the path to a local clone of https://github.com/googleapis/gapic-generator-go
    # or a clone of your fork.
    native.local_repository(
        name = "com_googleapis_gapic_generator_go",
        path = "PATH_TO_GAPIC_GENERATOR",
    )

    # Uncomment this section if the build should use gapic-generator-go master
    #
    # _maybe(
    #     http_archive,
    #     name = "com_googleapis_gapic_generator_go",
